...
// Enhanced Dynamic Header Component
const DynamicHeader = ({ type = 'home', onBell, onProfile, notificationCount = 0 }) => {
    ...
    const handleNavigation = (action) => {
        ...
        switch (action) {
            case 'urgent-booking':
                ...
                break;
            case 'post-job':
                // Navigate to PostJobScreen
                break;
            case 'find-interpreter':
                // Navigate to FindInterpreterScreen
                break;
            case 'messages':
    ...
    return (
        <View style={styles.container}>
            <DynamicHeader
                ...
                notificationCount={actionData.unreadMessages}
            />
