...
// Import theme from PostJobScreen (reusing the same theme for consistency)
const theme = {
    colors: {
        primary: '#4F46E5',
        primaryLight: '#818CF8',
...
const DynamicHeader = ({ type = 'back', title = 'Job Opportunities', onBack, onProfile }) => {
...
const InterpreterJobListingScreen = () => {
